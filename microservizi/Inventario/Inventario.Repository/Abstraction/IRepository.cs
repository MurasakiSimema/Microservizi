...
public interface IRepository
{
    ...
    Task<List<Fornitore>> ReadAllFornitoriAsync(CancellationToken cancellationToken = default);
    // Update
    Task<Fornitore?> UpdateFornitoreAsync(int id, string nome, string indirizzo, string telefono, string email, CancellationToken cancellationToken = default);
    // Delete
